...
export function adVideoNode(client: ApiClient, id: string) {
  return {
    ...
    boostAdsList: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/boost_ads_list`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    captions: {
    ...
    tags: <F extends (keyof TaggableSubjectFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<TaggableSubjectFields, F[number]>>(client, `${id}/tags`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    thumbnails: {
