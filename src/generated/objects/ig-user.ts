  ...
  return {
    ...
    brandedContentAdPermissions: {
      list: <F extends (keyof IGBCAdsPermissionFields)[]>(opts: { fields: F; params?: IGUserListBrandedContentAdPermissionsParams }) =>
        new Cursor<Pick<IGBCAdsPermissionFields, F[number]>>(client, `${id}/branded_content_ad_permissions`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    catalogProductSearch: <F extends (keyof ShadowIGUserCatalogProductSearchFields)[]>(opts: { fields: F; params?: IGUserListCatalogProductSearchParams }) =>
      new Cursor<Pick<ShadowIGUserCatalogProductSearchFields, F[number]>>(client, `${id}/catalog_product_search`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    collaborationInvites: {
      list: <F extends (keyof ShadowIGUserCollaborationInvitesFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<ShadowIGUserCollaborationInvitesFields, F[number]>>(client, `${id}/collaboration_invites`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    collaborativeMedia: <F extends (keyof ShadowIGUserCollaborativeMediaFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ShadowIGUserCollaborativeMediaFields, F[number]>>(client, `${id}/collaborative_media`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    connectedThreadsUser: <F extends (keyof ThreadsUserFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ThreadsUserFields, F[number]>>(client, `${id}/connected_threads_user`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    contentPublishingLimit: <F extends (keyof ContentPublishingLimitResponseFields)[]>(opts: { fields: F; params?: IGUserListContentPublishingLimitParams }) =>
      new Cursor<Pick<ContentPublishingLimitResponseFields, F[number]>>(client, `${id}/content_publishing_limit`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    creatorMarketplaceCreators: <F extends (keyof IGUserExportForCAMFields)[]>(opts: { fields: F; params?: IGUserListCreatorMarketplaceCreatorsParams }) =>
      new Cursor<Pick<IGUserExportForCAMFields, F[number]>>(client, `${id}/creator_marketplace_creators`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    dataset: {
    ...
    instagramBackedThreadsUser: {
      list: <F extends (keyof ThreadsUserFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<ThreadsUserFields, F[number]>>(client, `${id}/instagram_backed_threads_user`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    liveMedia: <F extends (keyof IGMediaFields)[]>(opts: { fields: F; params?: IGUserListLiveMediaParams }) =>
      new Cursor<Pick<IGMediaFields, F[number]>>(client, `${id}/live_media`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    media: {
      list: <F extends (keyof IGMediaFields)[]>(opts: { fields: F; params?: IGUserListMediaParams }) =>
        new Cursor<Pick<IGMediaFields, F[number]>>(client, `${id}/media`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    productAppeal: {
      list: <F extends (keyof IGShoppingProductAppealFields)[]>(opts: { fields: F; params?: IGUserListProductAppealParams }) =>
        new Cursor<Pick<IGShoppingProductAppealFields, F[number]>>(client, `${id}/product_appeal`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    recentlySearchedHashtags: <F extends (keyof ShadowIGHashtagFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ShadowIGHashtagFields, F[number]>>(client, `${id}/recently_searched_hashtags`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    scheduledMedia: <F extends (keyof ShadowIGScheduledMediaFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ShadowIGScheduledMediaFields, F[number]>>(client, `${id}/scheduled_media`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    stories: <F extends (keyof IGMediaFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<IGMediaFields, F[number]>>(client, `${id}/stories`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    tags: <F extends (keyof IGMediaFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<IGMediaFields, F[number]>>(client, `${id}/tags`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    upcomingEvents: {
