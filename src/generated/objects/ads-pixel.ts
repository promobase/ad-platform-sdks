...
export function adsPixelNode(client: ApiClient, id: string) {
  return {
    ...
    offlineEventUploads: <F extends (keyof OfflineConversionDataSetUploadFields)[]>(opts: { fields: F; params?: AdsPixelListOfflineEventUploadsParams }) =>
      new Cursor<Pick<OfflineConversionDataSetUploadFields, F[number]>>(client, `${id}/offline_event_uploads`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    stats: <F extends (keyof AdsPixelStatsResultFields)[]>(opts: { fields: F; params?: AdsPixelListStatsParams }) =>
      new Cursor<Pick<AdsPixelStatsResultFields, F[number]>>(client, `${id}/stats`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
  };
}
