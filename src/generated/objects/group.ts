...
export function groupNode(client: ApiClient, id: string) {
  return {
    ...
    docs: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/docs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    files: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/files`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    groups: {
    ...
    optedInMembers: <F extends (keyof UserFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<UserFields, F[number]>>(client, `${id}/opted_in_members`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
