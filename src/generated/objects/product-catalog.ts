...
export function productCatalogNode(client: ApiClient, id: string) {
  return {
    ...
    automotiveModels: <F extends (keyof AutomotiveModelFields)[]>(opts: { fields: F; params?: ProductCatalogListAutomotiveModelsParams }) =>
      new Cursor<Pick<AutomotiveModelFields, F[number]>>(client, `${id}/automotive_models`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    categories: {
      list: <F extends (keyof ProductCatalogCategoryFields)[]>(opts: { fields: F; params?: ProductCatalogListCategoriesParams }) =>
        new Cursor<Pick<ProductCatalogCategoryFields, F[number]>>(client, `${id}/categories`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    checkBatchRequestStatus: <F extends (keyof CheckBatchRequestStatusFields)[]>(opts: { fields: F; params?: ProductCatalogListCheckBatchRequestStatusParams }) =>
      new Cursor<Pick<CheckBatchRequestStatusFields, F[number]>>(client, `${id}/check_batch_request_status`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    checkMarketplacePartnerDealsStatus: <F extends (keyof ProductCatalogCheckMarketplacePartnerDealsStatusFields)[]>(opts: { fields: F; params?: ProductCatalogListCheckMarketplacePartnerDealsStatusParams }) =>
      new Cursor<Pick<ProductCatalogCheckMarketplacePartnerDealsStatusFields, F[number]>>(client, `${id}/check_marketplace_partner_deals_status`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    checkMarketplacePartnerSellersStatus: <F extends (keyof ProductCatalogCheckMarketplacePartnerSellersStatusFields)[]>(opts: { fields: F; params?: ProductCatalogListCheckMarketplacePartnerSellersStatusParams }) =>
      new Cursor<Pick<ProductCatalogCheckMarketplacePartnerSellersStatusFields, F[number]>>(client, `${id}/check_marketplace_partner_sellers_status`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    collaborativeAdsLsbImageBank: <F extends (keyof CPASLsbImageBankFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CPASLsbImageBankFields, F[number]>>(client, `${id}/collaborative_ads_lsb_image_bank`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    collaborativeAdsShareSettings: <F extends (keyof CollaborativeAdsShareSettingsFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CollaborativeAdsShareSettingsFields, F[number]>>(client, `${id}/collaborative_ads_share_settings`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    creatorAssetCreatives: <F extends (keyof CreatorAssetCreativeFields)[]>(opts: { fields: F; params?: ProductCatalogListCreatorAssetCreativesParams }) =>
      new Cursor<Pick<CreatorAssetCreativeFields, F[number]>>(client, `${id}/creator_asset_creatives`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    dataSources: <F extends (keyof ProductCatalogDataSourceFields)[]>(opts: { fields: F; params?: ProductCatalogListDataSourcesParams }) =>
      new Cursor<Pick<ProductCatalogDataSourceFields, F[number]>>(client, `${id}/data_sources`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    destinations: <F extends (keyof DestinationFields)[]>(opts: { fields: F; params?: ProductCatalogListDestinationsParams }) =>
      new Cursor<Pick<DestinationFields, F[number]>>(client, `${id}/destinations`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    diagnostics: <F extends (keyof ProductCatalogDiagnosticGroupFields)[]>(opts: { fields: F; params?: ProductCatalogListDiagnosticsParams }) =>
      new Cursor<Pick<ProductCatalogDiagnosticGroupFields, F[number]>>(client, `${id}/diagnostics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    flights: <F extends (keyof FlightFields)[]>(opts: { fields: F; params?: ProductCatalogListFlightsParams }) =>
      new Cursor<Pick<FlightFields, F[number]>>(client, `${id}/flights`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    homeListings: {
      list: <F extends (keyof HomeListingFields)[]>(opts: { fields: F; params?: ProductCatalogListHomeListingsParams }) =>
        new Cursor<Pick<HomeListingFields, F[number]>>(client, `${id}/home_listings`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    hotels: {
      list: <F extends (keyof HotelFields)[]>(opts: { fields: F; params?: ProductCatalogListHotelsParams }) =>
        new Cursor<Pick<HotelFields, F[number]>>(client, `${id}/hotels`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    productFeeds: {
      list: <F extends (keyof ProductFeedFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<ProductFeedFields, F[number]>>(client, `${id}/product_feeds`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    productGroups: {
      list: <F extends (keyof ProductGroupFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<ProductGroupFields, F[number]>>(client, `${id}/product_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    productSets: {
      list: <F extends (keyof ProductSetFields)[]>(opts: { fields: F; params?: ProductCatalogListProductSetsParams }) =>
        new Cursor<Pick<ProductSetFields, F[number]>>(client, `${id}/product_sets`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    productSetsBatch: <F extends (keyof ProductCatalogProductSetsBatchFields)[]>(opts: { fields: F; params?: ProductCatalogListProductSetsBatchParams }) =>
      new Cursor<Pick<ProductCatalogProductSetsBatchFields, F[number]>>(client, `${id}/product_sets_batch`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    products: {
      list: <F extends (keyof ProductItemFields)[]>(opts: { fields: F; params?: ProductCatalogListProductsParams }) =>
        new Cursor<Pick<ProductItemFields, F[number]>>(client, `${id}/products`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    vehicleOffers: <F extends (keyof VehicleOfferFields)[]>(opts: { fields: F; params?: ProductCatalogListVehicleOffersParams }) =>
      new Cursor<Pick<VehicleOfferFields, F[number]>>(client, `${id}/vehicle_offers`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    vehicles: {
      list: <F extends (keyof VehicleFields)[]>(opts: { fields: F; params?: ProductCatalogListVehiclesParams }) =>
        new Cursor<Pick<VehicleFields, F[number]>>(client, `${id}/vehicles`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    versionConfigs: <F extends (keyof CatalogContentVersionConfigFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CatalogContentVersionConfigFields, F[number]>>(client, `${id}/version_configs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
