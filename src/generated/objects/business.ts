...
export function businessNode(client: ApiClient, id: string) {
  return {
    ...
    adAccountInfos: <F extends (keyof ALMAdAccountInfoFields)[]>(opts: { fields: F; params?: BusinessListAdAccountInfosParams }) =>
      new Cursor<Pick<ALMAdAccountInfoFields, F[number]>>(client, `${id}/ad_account_infos`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    adCustomDerivedMetrics: <F extends (keyof AdCustomDerivedMetricsFields)[]>(opts: { fields: F; params?: BusinessListAdCustomDerivedMetricsParams }) =>
      new Cursor<Pick<AdCustomDerivedMetricsFields, F[number]>>(client, `${id}/ad_custom_derived_metrics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    anPlacements: <F extends (keyof AdPlacementFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<AdPlacementFields, F[number]>>(client, `${id}/an_placements`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    businessAssetGroups: <F extends (keyof BusinessAssetGroupFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessAssetGroupFields, F[number]>>(client, `${id}/business_asset_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    businessInvoices: <F extends (keyof OmegaCustomerTrxFields)[]>(opts: { fields: F; params?: BusinessListBusinessInvoicesParams }) =>
      new Cursor<Pick<OmegaCustomerTrxFields, F[number]>>(client, `${id}/business_invoices`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    businessUsers: {
    ...
    clientAdAccounts: <F extends (keyof AdAccountFields)[]>(opts: { fields: F; params?: BusinessListClientAdAccountsParams }) =>
      new Cursor<Pick<AdAccountFields, F[number]>>(client, `${id}/client_ad_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    clientApps: {
    ...
    clientOffsiteSignalContainerBusinessObjects: <F extends (keyof OffsiteSignalContainerBusinessObjectFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<OffsiteSignalContainerBusinessObjectFields, F[number]>>(client, `${id}/client_offsite_signal_container_business_objects`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    clientPages: {
    ...
    clientProductCatalogs: <F extends (keyof ProductCatalogFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ProductCatalogFields, F[number]>>(client, `${id}/client_product_catalogs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    collaborativeAdsCollaborationRequests: <F extends (keyof CPASCollaborationRequestFields)[]>(opts: { fields: F; params?: BusinessListCollaborativeAdsCollaborationRequestsParams }) =>
      new Cursor<Pick<CPASCollaborationRequestFields, F[number]>>(client, `${id}/collaborative_ads_collaboration_requests`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    collaborativeAdsSuggestedPartners: <F extends (keyof CPASAdvertiserPartnershipRecommendationFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CPASAdvertiserPartnershipRecommendationFields, F[number]>>(client, `${id}/collaborative_ads_suggested_partners`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    cpasBusinessSetupConfig: {
      list: <F extends (keyof CPASBusinessSetupConfigFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<CPASBusinessSetupConfigFields, F[number]>>(client, `${id}/cpas_business_setup_config`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    cpasMerchantConfig: <F extends (keyof CPASMerchantConfigFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CPASMerchantConfigFields, F[number]>>(client, `${id}/cpas_merchant_config`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    creditcards: <F extends (keyof CreditCardFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CreditCardFields, F[number]>>(client, `${id}/creditcards`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    eventSourceGroups: {
      list: <F extends (keyof EventSourceGroupFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<EventSourceGroupFields, F[number]>>(client, `${id}/event_source_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    extendedcreditapplications: <F extends (keyof ExtendedCreditApplicationFields)[]>(opts: { fields: F; params?: BusinessListExtendedcreditapplicationsParams }) =>
      new Cursor<Pick<ExtendedCreditApplicationFields, F[number]>>(client, `${id}/extendedcreditapplications`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    extendedcredits: <F extends (keyof ExtendedCreditFields)[]>(opts: { fields: F; params?: BusinessListExtendedcreditsParams }) =>
      new Cursor<Pick<ExtendedCreditFields, F[number]>>(client, `${id}/extendedcredits`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    managedPartnerAdsFundingSourceDetails: <F extends (keyof FundingSourceDetailsCouponFields)[]>(opts: { fields: F; params?: BusinessListManagedPartnerAdsFundingSourceDetailsParams }) =>
      new Cursor<Pick<FundingSourceDetailsCouponFields, F[number]>>(client, `${id}/managed_partner_ads_funding_source_details`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    openbridgeConfigurations: {
      list: <F extends (keyof OpenBridgeConfigurationFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<OpenBridgeConfigurationFields, F[number]>>(client, `${id}/openbridge_configurations`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    ownedInstagramAccounts: <F extends (keyof IGUserFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<IGUserFields, F[number]>>(client, `${id}/owned_instagram_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ownedInstagramAssets: <F extends (keyof InstagramBusinessAssetFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<InstagramBusinessAssetFields, F[number]>>(client, `${id}/owned_instagram_assets`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ownedOffsiteSignalContainerBusinessObjects: <F extends (keyof OffsiteSignalContainerBusinessObjectFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<OffsiteSignalContainerBusinessObjectFields, F[number]>>(client, `${id}/owned_offsite_signal_container_business_objects`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ownedPages: {
      list: <F extends (keyof PageFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
    ...
    ownedProductCatalogs: {
      list: <F extends (keyof ProductCatalogFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<ProductCatalogFields, F[number]>>(client, `${id}/owned_product_catalogs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    ownedWhatsappBusinessAccounts: <F extends (keyof WhatsAppBusinessAccountFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<WhatsAppBusinessAccountFields, F[number]>>(client, `${id}/owned_whatsapp_business_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    partnerAccountLinking: <F extends (keyof PartnerAccountLinkingFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<PartnerAccountLinkingFields, F[number]>>(client, `${id}/partner_account_linking`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    passbackAttributionMetadataConfigs: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/passback_attribution_metadata_configs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingClientAdAccounts: <F extends (keyof BusinessAdAccountRequestFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessAdAccountRequestFields, F[number]>>(client, `${id}/pending_client_ad_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingClientApps: <F extends (keyof BusinessApplicationRequestFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessApplicationRequestFields, F[number]>>(client, `${id}/pending_client_apps`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingClientPages: <F extends (keyof BusinessPageRequestFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessPageRequestFields, F[number]>>(client, `${id}/pending_client_pages`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingOwnedAdAccounts: <F extends (keyof BusinessAdAccountRequestFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessAdAccountRequestFields, F[number]>>(client, `${id}/pending_owned_ad_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingOwnedPages: <F extends (keyof BusinessPageRequestFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessPageRequestFields, F[number]>>(client, `${id}/pending_owned_pages`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingSharedOffsiteSignalContainerBusinessObjects: <F extends (keyof OffsiteSignalContainerBusinessObjectFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<OffsiteSignalContainerBusinessObjectFields, F[number]>>(client, `${id}/pending_shared_offsite_signal_container_business_objects`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    pendingUsers: <F extends (keyof BusinessRoleRequestFields)[]>(opts: { fields: F; params?: BusinessListPendingUsersParams }) =>
      new Cursor<Pick<BusinessRoleRequestFields, F[number]>>(client, `${id}/pending_users`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    preverifiedNumbers: <F extends (keyof WhatsAppBusinessPreVerifiedPhoneNumberFields)[]>(opts: { fields: F; params?: BusinessListPreverifiedNumbersParams }) =>
      new Cursor<Pick<WhatsAppBusinessPreVerifiedPhoneNumberFields, F[number]>>(client, `${id}/preverified_numbers`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    receivedAudienceSharingRequests: <F extends (keyof BusinessAssetSharingAgreementFields)[]>(opts: { fields: F; params?: BusinessListReceivedAudienceSharingRequestsParams }) =>
      new Cursor<Pick<BusinessAssetSharingAgreementFields, F[number]>>(client, `${id}/received_audience_sharing_requests`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    resellerGuidances: <F extends (keyof ResellerGuidanceFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ResellerGuidanceFields, F[number]>>(client, `${id}/reseller_guidances`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    selfCertifiedWhatsappBusinessSubmissions: <F extends (keyof WhatsAppBusinessPartnerClientVerificationSubmissionFields)[]>(opts: { fields: F; params?: BusinessListSelfCertifiedWhatsappBusinessSubmissionsParams }) =>
      new Cursor<Pick<WhatsAppBusinessPartnerClientVerificationSubmissionFields, F[number]>>(client, `${id}/self_certified_whatsapp_business_submissions`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    systemUsers: {
      list: <F extends (keyof SystemUserFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<SystemUserFields, F[number]>>(client, `${id}/system_users`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    thirdPartyMeasurementReportDataset: <F extends (keyof ThirdPartyMeasurementReportDatasetFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ThirdPartyMeasurementReportDatasetFields, F[number]>>(client, `${id}/third_party_measurement_report_dataset`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
