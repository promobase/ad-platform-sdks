...
export function offlineConversionDataSetNode(client: ApiClient, id: string) {
  return {
    ...
    audiences: <F extends (keyof CustomAudienceFields)[]>(opts: { fields: F; params?: OfflineConversionDataSetListAudiencesParams }) =>
      new Cursor<Pick<CustomAudienceFields, F[number]>>(client, `${id}/audiences`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    serverEventsPermittedBusiness: <F extends (keyof BusinessFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessFields, F[number]>>(client, `${id}/server_events_permitted_business`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    sharedAgencies: <F extends (keyof BusinessFields)[]>(opts: { fields: F; params?: OfflineConversionDataSetListSharedAgenciesParams }) =>
      new Cursor<Pick<BusinessFields, F[number]>>(client, `${id}/shared_agencies`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    stats: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: OfflineConversionDataSetListStatsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/stats`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    uploads: <F extends (keyof OfflineConversionDataSetUploadFields)[]>(opts: { fields: F; params?: OfflineConversionDataSetListUploadsParams }) =>
      new Cursor<Pick<OfflineConversionDataSetUploadFields, F[number]>>(client, `${id}/uploads`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
  };
}
