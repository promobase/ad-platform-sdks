...
export function adSetNode(client: ApiClient, id: string) {
  return {
    ...
    adrulesGoverned: <F extends (keyof AdRuleFields)[]>(opts: { fields: F; params?: AdSetListAdrulesGovernedParams }) =>
      new Cursor<Pick<AdRuleFields, F[number]>>(client, `${id}/adrules_governed`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    asyncadrequests: <F extends (keyof AdAsyncRequestFields)[]>(opts: { fields: F; params?: AdSetListAsyncadrequestsParams }) =>
      new Cursor<Pick<AdAsyncRequestFields, F[number]>>(client, `${id}/asyncadrequests`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    budgetSchedules: {
      list: <F extends (keyof HighDemandPeriodFields)[]>(opts: { fields: F; params?: AdSetListBudgetSchedulesParams }) =>
        new Cursor<Pick<HighDemandPeriodFields, F[number]>>(client, `${id}/budget_schedules`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    copies: {
      list: <F extends (keyof AdSetFields)[]>(opts: { fields: F; params?: AdSetListCopiesParams }) =>
        new Cursor<Pick<AdSetFields, F[number]>>(client, `${id}/copies`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    deliveryEstimate: <F extends (keyof AdCampaignDeliveryEstimateFields)[]>(opts: { fields: F; params?: AdSetListDeliveryEstimateParams }) =>
      new Cursor<Pick<AdCampaignDeliveryEstimateFields, F[number]>>(client, `${id}/delivery_estimate`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    insights: {
