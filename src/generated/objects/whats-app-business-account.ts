...
export function whatsAppBusinessAccountNode(client: ApiClient, id: string) {
  return {
    ...
    audiences: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/audiences`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    callAnalytics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListCallAnalyticsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/call_analytics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    conversationAnalytics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListConversationAnalyticsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/conversation_analytics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    dataset: {
    ...
    degreesOfFreedomSpec: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/degrees_of_freedom_spec`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    flows: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/flows`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    groupAnalytics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListGroupAnalyticsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/group_analytics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    messageCampaigns: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/message_campaigns`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    messageTemplatePreviews: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListMessageTemplatePreviewsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/message_template_previews`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    messageTemplates: {
    ...
    paymentConfigurations: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/payment_configurations`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    phoneNumbers: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/phone_numbers`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    schedules: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/schedules`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    solutions: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/solutions`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    subscribedApps: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
    ...
    templateAnalytics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListTemplateAnalyticsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/template_analytics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    templateGroupAnalytics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListTemplateGroupAnalyticsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/template_group_analytics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    templateGroups: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/template_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    templatePerformanceMetrics: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: WhatsAppBusinessAccountListTemplatePerformanceMetricsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/template_performance_metrics`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
