...
export function contentBlockListNode(client: ApiClient, id: string) {
  return {
    ...
    appliedAdAccounts: <F extends (keyof AdAccountFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<AdAccountFields, F[number]>>(client, `${id}/applied_ad_accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    facebookContent: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/facebook_content`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    instagramContent: <F extends (keyof IGMediaFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<IGMediaFields, F[number]>>(client, `${id}/instagram_content`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
  };
}
