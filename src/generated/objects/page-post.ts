...
export interface PagePostListCommentsParams {
  filter?: string;
  live_filter?: string;
  order?: string;
  since?: string;
...
export interface PagePostCreateCommentsParams {
...
export interface PagePostListInsightsParams {
  date_preset?: string;
...
export interface PagePostListReactionsParams {
  type?: string;
  [key: string]: unknown;
}

export interface PagePostUpdateParams {
...
export function pagePostNode(client: ApiClient, id: string) {
  return {
    ...
    update: (params: PagePostUpdateParams) =>
      client.post<PagePostFields>(`${id}`, params as Record<string, unknown>),
    delete: () =>
      client.delete(`${id}`, {}),
    attachments: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/attachments`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    comments: {
    ...
    dynamicPosts: <F extends (keyof RTBDynamicPostFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<RTBDynamicPostFields, F[number]>>(client, `${id}/dynamic_posts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    sharedposts: <F extends (keyof PostFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<PostFields, F[number]>>(client, `${id}/sharedposts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    to: <F extends (keyof ProfileFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ProfileFields, F[number]>>(client, `${id}/to`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
  };
}
