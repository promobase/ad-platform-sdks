  ...
  return {
    ...
    accounts: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListAccountsParams }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/accounts`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    adPlacementGroups: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/ad_placement_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    adnetworkPlacements: <F extends (keyof AdPlacementFields)[]>(opts: { fields: F; params?: ApplicationListAdnetworkPlacementsParams }) =>
      new Cursor<Pick<AdPlacementFields, F[number]>>(client, `${id}/adnetwork_placements`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    adnetworkanalytics: {
    ...
    aemAttribution: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListAemAttributionParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/aem_attribution`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    aemConversionConfigs: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListAemConversionConfigsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/aem_conversion_configs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    aemConversionFilter: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListAemConversionFilterParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/aem_conversion_filter`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    androidDialogConfigs: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/android_dialog_configs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    appCapiSettings: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/app_capi_settings`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    appEventTypes: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/app_event_types`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    appInstalledGroups: <F extends (keyof GroupFields)[]>(opts: { fields: F; params?: ApplicationListAppInstalledGroupsParams }) =>
      new Cursor<Pick<GroupFields, F[number]>>(client, `${id}/app_installed_groups`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    appassets: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/appassets`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    buttonAutoDetectionDeviceSelection: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListButtonAutoDetectionDeviceSelectionParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/button_auto_detection_device_selection`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    cloudbridgeSettings: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/cloudbridge_settings`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    connectedClientBusinesses: <F extends (keyof BusinessFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<BusinessFields, F[number]>>(client, `${id}/connected_client_businesses`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    iapPurchases: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListIapPurchasesParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/iap_purchases`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    iosDialogConfigs: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/ios_dialog_configs`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    linkedDataset: <F extends (keyof AdsDatasetFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<AdsDatasetFields, F[number]>>(client, `${id}/linked_dataset`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    mobileSdkGk: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListMobileSdkGkParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/mobile_sdk_gk`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    monetizedDigitalStoreObjects: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/monetized_digital_store_objects`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    objectTypes: <F extends (keyof NullNodeFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<NullNodeFields, F[number]>>(client, `${id}/object_types`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    objects: <F extends (keyof NullNodeFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<NullNodeFields, F[number]>>(client, `${id}/objects`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    products: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListProductsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/products`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    purchases: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/purchases`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    roles: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/roles`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    serverDomainInfos: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/server_domain_infos`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    sgwDatasetStatus: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListSgwDatasetStatusParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/sgw_dataset_status`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    sgwInstallDeferralLink: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListSgwInstallDeferralLinkParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/sgw_install_deferral_link`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    subscriptions: {
      list: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
        new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/subscriptions`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    threatPrivacyGroupsMember: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListThreatPrivacyGroupsMemberParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/threat_privacy_groups_member`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    threatPrivacyGroupsOwner: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListThreatPrivacyGroupsOwnerParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/threat_privacy_groups_owner`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
    ...
    whatsappBusinessSolutions: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: ApplicationListWhatsappBusinessSolutionsParams }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/whatsapp_business_solutions`, opts as { fields: readonly string[]; params?: Record<string, unknown> }),
  };
}
