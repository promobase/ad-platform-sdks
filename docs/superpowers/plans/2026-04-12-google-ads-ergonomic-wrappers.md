...
**Goal:** Ship hand-written ergonomic wrappers for the campaign-lifecycle resources in `@mosaic/google-ads`, exposed via a `Google.Ads.customer(client, customerId)` factory.
...
**Tech Stack:** TypeScript, Bun, `@mosaic/sdk-runtime` `HttpClient`, generated v23 services.
