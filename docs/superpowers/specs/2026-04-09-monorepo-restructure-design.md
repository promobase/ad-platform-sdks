...
ad-platform-sdks/
├── packages/
│   ├── sdk-runtime/                    # @mosaic/sdk-runtime
│   │   ├── src/
...
│   │   │   ├── cursor.test.ts
│   │   │   └── errors.test.ts
│   │   ├── package.json               # @mosaic/sdk-runtime (private: true — NOT published)
│   │   └── tsconfig.json
│   │
│   ├── meta-business-sdk/              # @mosaic/meta
...
│   │   ├── package.json               # depends on @mosaic/sdk-runtime
│   │   ├── tsconfig.json
│   │   ├── CLAUDE.md                  # Meta SDK-specific instructions
│   │   └── README.md                  # Meta SDK README
│   │
│   ├── tiktok-business-sdk/           # future — @mosaic/tiktok-ts
...
Keeps all Meta-specific code. Depends on `@mosaic/sdk-runtime`.

**Changes from current:**
- `src/runtime/` removed — now imports from `@mosaic/sdk-runtime`
- `src/errors.ts` — `FacebookApiError extends ApiError` with `code`, `subcode`, `type`, `fbtrace_id`
- `src/codegen/` — emitter updated to import from `@mosaic/sdk-runtime` instead of `../../runtime/`
...
10. Update codegen emitter to use new import paths (`@mosaic/sdk-runtime` instead of `../../runtime/`)
