    ...
    ig_publish_photo: tool({
      ...
      inputSchema: z.object({
        ...
        collaborators: z
          .array(z.string())
          .optional()
          .describe("Instagram usernames to tag as collaborators (max 5)"),
    ...
    ig_publish_carousel: tool({
      ...
      inputSchema: z.object({
        items: z
          ...
          .min(2)
          .max(10)
          .describe("Carousel items (2-10)"),
        caption: z.string().optional().describe("Post caption text"),
        collaborators: z
          .array(z.string())
          .optional()
          .describe("Instagram usernames to tag as collaborators"),
        locationId: z.string().optional().describe("Location ID to tag"),
      }),
    ...
    ig_publish_story: tool({
      ...
      inputSchema: z.object({
        imageUrl: z
          .string()
          .optional()
          .describe("Public URL of the image (provide either imageUrl or videoUrl)"),
        videoUrl: z
          .string()
          .optional()
          .describe("Public URL of the video (provide either imageUrl or videoUrl)"),
      }),
    ...
    ig_get_media_insights: tool({
      ...
      inputSchema: z.object({
        ...
        metrics: z
          .array(z.string())
          .optional()
          .describe("Metrics to fetch (default: impressions, reach, engagement)"),
      }),
    ...
    ig_webhook_subscribe: tool({
      ...
      inputSchema: z.object({
        fields: z
          .array(z.string())
          .optional()
          .describe("Event fields to subscribe to (default: comments, messages, message_edit)"),
      }),
