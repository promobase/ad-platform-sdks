...
export function commerceMerchantSettingsNode(client: ApiClient, id: string) {
  return {
    ...
    setupStatus: <F extends (keyof CommerceMerchantSettingsSetupStatusFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<CommerceMerchantSettingsSetupStatusFields, F[number]>>(client, `${id}/setup_status`, opts as { fields: readonly string[]; params?: Record<string, unknown> }, metaPagination()),
    ...
    shops: <F extends (keyof ShopFields)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<ShopFields, F[number]>>(client, `${id}/shops`, opts as { fields: readonly string[]; params?: Record<string, unknown> }, metaPagination()),
    taxSettings: <F extends (keyof Record<string, unknown>)[]>(opts: { fields: F; params?: Record<string, unknown> }) =>
      new Cursor<Pick<Record<string, unknown>, F[number]>>(client, `${id}/tax_settings`, opts as { fields: readonly string[]; params?: Record<string, unknown> }, metaPagination()),
  };
}
