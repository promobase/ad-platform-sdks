...
export const tiktok_mCPAuthorization_nOpenMcpServer = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServer",
  platform: "tiktok",
  method: "POST",
  path: "/open_mcp/{server}/",
  summary: "Use MCP tools",
  effect: "write",
  execution: "durable",
  idempotency: "unsafe",
  requiredScopes: [],
  ...
  outputSchema: Models.NOpenMcpServerResponse,
});

export const tiktok_mCPAuthorization_nOpenMcpServerOauthRegister = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServerOauthRegister",
  platform: "tiktok",
  method: "POST",
  path: "/open_mcp/{server}/oauth/register/",
  ...
  outputSchema: Models.NOpenMcpServerOauthRegisterResponse,
});

export const tiktok_mCPAuthorization_nOpenMcpServerOauthRevoke = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServerOauthRevoke",
  platform: "tiktok",
  method: "POST",
  path: "/open_mcp/{server}/oauth/revoke/",
  ...
  outputSchema: Models.NOpenMcpServerOauthRevokeResponse,
});

export const tiktok_mCPAuthorization_nOpenMcpServerOauthToken = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServerOauthToken",
  platform: "tiktok",
  method: "POST",
  path: "/open_mcp/{server}/oauth/token/",
  summary: "Exchange an MCP authorization code for tokens",
  effect: "write",
  execution: "durable",
  idempotency: "unsafe",
  requiredScopes: [],
  ...
  outputSchema: Models.NOpenMcpServerOauthTokenResponse,
});

export const tiktok_mCPAuthorization_nOpenMcpServerOauthToken2 = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServerOauthToken2",
  platform: "tiktok",
  method: "POST",
  path: "/open_mcp/{server}/oauth/token/",
...
export const tiktok_mCPAuthorization_nOpenMcpServerOauthWellKnownOpenidConfiguration = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nOpenMcpServerOauthWellKnownOpenidConfiguration",
  platform: "tiktok",
  method: "GET",
  path: "/open_mcp/{server}/oauth/.well-known/openid-configuration/",
  ...
  outputSchema: Models.NOpenMcpServerOauthWellKnownOpenidConfigurationResponse,
});

export const tiktok_mCPAuthorization_nPortalMcpTt4bAuthorize = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nPortalMcpTt4bAuthorize",
  platform: "tiktok",
  method: "GET",
  path: "/portal/mcp-tt4b-authorize/",
  ...
  outputSchema: Models.NPortalMcpTt4bAuthorizeResponse,
});

export const tiktok_mCPAuthorization_nWellKnownOauthProtectedResourceOpenMcpServer = defineEndpointDescriptor({
  id: "tiktok.mCPAuthorization.nWellKnownOauthProtectedResourceOpenMcpServer",
  platform: "tiktok",
  method: "GET",
  path: "/.well-known/oauth-protected-resource/open_mcp/{server}/",
  summary: "Discover authorization servers",
  effect: "read",
  execution: "inline",
  idempotency: "safe",
  requiredScopes: [],
  ...
  outputSchema: Models.NWellKnownOauthProtectedResourceOpenMcpServerResponse,
});
