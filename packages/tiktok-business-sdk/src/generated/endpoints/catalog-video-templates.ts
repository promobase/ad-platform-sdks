...
import type { CatalogVideoPackageGetParams, CatalogVideoPackageGetResponse } from "../types/catalog-video-templates.ts";
...
export function createCatalogVideoTemplates(opts: { accessToken: string; advertiserId: string }) {
