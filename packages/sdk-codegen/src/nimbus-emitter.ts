...
> = {
  tiktok: {
    ...
    effectImport: "@openpromo/tiktok/effect",
    order: 20,
  },
  "google-ads": {
    label: "Google Ads",
    packageName: "@openpromo/google-ads",
    effectImport: "@openpromo/google-ads/v25/effect",
    order: 30,
  },
  "google-business-profile": {
    label: "Google Business Profile",
    packageName: "@openpromo/google-business-profile",
    effectImport: "@openpromo/google-business-profile/effect",
    order: 40,
  },
  linkedin: {
    label: "LinkedIn",
    packageName: "@openpromo/linkedin",
    effectImport: "@openpromo/linkedin/effect",
    order: 50,
  },
  x: {
    label: "X",
    packageName: "@openpromo/x",
    effectImport: "@openpromo/x/effect",
    order: 60,
  },
  youtube: {
    label: "YouTube",
    packageName: "@openpromo/youtube",
  ...
  "amazon-ads": {
    ...
    effectImport: "@openpromo/amazon-ads",
    order: 110,
  },
  "amazon-ads-sp": {
    label: "Amazon Ads — Sponsored Products",
    packageName: "@openpromo/amazon-ads",
    effectImport: "@openpromo/amazon-ads/sponsored-products/effect",
    order: 111,
  },
  "amazon-ads-sb": {
    label: "Amazon Ads — Sponsored Brands",
    packageName: "@openpromo/amazon-ads",
    effectImport: "@openpromo/amazon-ads/sponsored-brands/effect",
    order: 112,
  },
  "amazon-ads-sd": {
    label: "Amazon Ads — Sponsored Display",
    packageName: "@openpromo/amazon-ads",
    effectImport: "@openpromo/amazon-ads/sponsored-display/effect",
    order: 113,
  },
  "amazon-ads-api": {
    label: "Amazon Ads API",
    packageName: "@openpromo/amazon-ads",
    effectImport: "@openpromo/amazon-ads/api/effect",
    order: 114,
  },
  bluesky: {
    label: "Bluesky",
