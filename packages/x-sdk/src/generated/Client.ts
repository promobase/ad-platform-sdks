...
import { TweetsClient } from "./api/resources/tweets/client/Client.js";
...
export class XApiClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<XApiClient.Options>;
    protected _media: MediaClient | undefined;
    protected _tweets: TweetsClient | undefined;
    protected _users: UsersClient | undefined;

    constructor(options: XApiClient.Options) {
    ...
    public get tweets(): TweetsClient {
        return (this._tweets ??= new TweetsClient(this._options));
    }
