// @generated
// fingerprint: sha256:d966fbb955b7f3aa589e00071ab55536e56f6d2f836ca06a015be7d26bf5f136
// DO NOT EDIT: generated file; changes will be overwritten.
import type { InteractionEventType, QualityScoreBucket, SearchVolumeRange } from "../index.ts";

// Generated from google.ads.googleads.v25.common.Metrics. Do not edit by hand.
export interface Metrics {
  ...
  allAverageCartSize?: number;
  allAverageOrderValueMicros?: string;
  allCostOfGoodsSoldMicros?: string;
  allCrossSellCostOfGoodsSoldMicros?: string;
  allCrossSellGrossProfitMicros?: string;
  allCrossSellRevenueMicros?: string;
  allCrossSellUnitsSold?: number;
  allGrossProfitMargin?: number;
  allGrossProfitMicros?: string;
  allLeadCostOfGoodsSoldMicros?: string;
  allLeadGrossProfitMicros?: string;
  allLeadRevenueMicros?: string;
  allLeadUnitsSold?: number;
  allOrders?: number;
  allRevenueMicros?: string;
  allUnitsSold?: number;
  controlCostPerConversion?: number;
  costPerConversionMarginOfError?: number;
  costPerConversionPValue?: number;
  costPerConversionChangePointEstimate?: number;
  controlConversions?: number;
  conversionsAbsoluteChangeMarginOfError?: number;
  conversionsAbsoluteChangePValue?: number;
  conversionsAbsoluteChangePointEstimate?: number;
  controlConversionValuePerCost?: number;
  conversionValuePerCostMarginOfError?: number;
  conversionValuePerCostPValue?: number;
  conversionValuePerCostChangePointEstimate?: number;
  controlCostMicros?: string;
  costMicrosMarginOfError?: number;
  costMicrosPValue?: number;
  costMicrosChangePointEstimate?: number;
  controlImpressions?: string;
  impressionsMarginOfError?: number;
  impressionsPValue?: number;
  impressionsPointEstimate?: number;
  clicksMarginOfError?: number;
  clicksPValue?: number;
  clicksPointEstimate?: number;
  controlConversionValue?: number;
  conversionValueMarginOfError?: number;
  conversionValuePValue?: number;
  conversionValueChangePointEstimate?: number;
  youtubeComments?: string;
  youtubeLikes?: string;
  youtubeShares?: string;
}
