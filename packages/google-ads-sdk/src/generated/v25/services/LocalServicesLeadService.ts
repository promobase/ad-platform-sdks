// @generated
// fingerprint: sha256:2a92778fa4d61f9c61418e2bc1e41572d83e39a3016da3e2fcd2f697ba288be7
...
// Generated from google.ads.googleads.v25.services.LocalServicesLeadService. Do not edit by hand.
export const localServicesLeadService = {
  appendLeadConversation(client: HttpClient, customerId: string, body: Omit<AppendLeadConversationRequest, "customerId">): Promise<AppendLeadConversationResponse> {
    return client.post<AppendLeadConversationResponse>(`/v25/customers/${customerId}/localServices:appendLeadConversation`, body);
  },
  ...
  provideLeadFeedback(client: HttpClient, resourceName: string, body: Omit<ProvideLeadFeedbackRequest, "resourceName">): Promise<ProvideLeadFeedbackResponse> {
    return client.post<ProvideLeadFeedbackResponse>(`/v25/${resourceName}:provideLeadFeedback`, body);
  }
};
