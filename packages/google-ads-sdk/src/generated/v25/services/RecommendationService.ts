// @generated
// fingerprint: sha256:d10bce26e82f125286c25bbe8dadd3daba4beed495a4909596afc1ef1c84ac8c
...
// Generated from google.ads.googleads.v25.services.RecommendationService. Do not edit by hand.
export const recommendationService = {
  applyRecommendation(client: HttpClient, customerId: string, body: Omit<ApplyRecommendationRequest, "customerId">): Promise<ApplyRecommendationResponse> {
    return client.post<ApplyRecommendationResponse>(`/v25/customers/${customerId}/recommendations:apply`, body);
  },
  ...
  dismissRecommendation(client: HttpClient, customerId: string, body: Omit<DismissRecommendationRequest, "customerId">): Promise<DismissRecommendationResponse> {
    return client.post<DismissRecommendationResponse>(`/v25/customers/${customerId}/recommendations:dismiss`, body);
  },
  ...
  generateRecommendations(client: HttpClient, customerId: string, body: Omit<GenerateRecommendationsRequest, "customerId">): Promise<GenerateRecommendationsResponse> {
    return client.post<GenerateRecommendationsResponse>(`/v25/customers/${customerId}/recommendations:generate`, body);
  }
};
